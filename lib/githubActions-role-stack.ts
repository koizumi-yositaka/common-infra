...
const REPOSITORY_NAME_LIST = ["manage-work-lambda","common-infra","quiz-maker-lambda","quiz-distributor","manage-work-react"]
...
export class GitHubActionsRoleStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const stringLike = REPOSITORY_NAME_LIST.map(x => `repo:${GITHUB_USERNAME}/${x}:*`);
